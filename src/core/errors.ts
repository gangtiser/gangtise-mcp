...
const ERROR_HINTS: Record<string, string> = {
  ...
  "900002": "请求缺少 uid。",
  "900001": "请求参数为空或缺少必填项。",
  "100003": "参数值非法（服务端不指明是哪个参数）：请对照工具参数说明检查枚举参数的拼写与取值。",
  "110003": "超出时间范围限制：该接口取数窗口随账号权限变化，请缩小日期范围或改用更近日期。",
  "8000014": "GANGTISE_ACCESS_KEY 错误。",
  "8000015": "GANGTISE_SECRET_KEY 错误。",
  "8000016": "开发账号状态异常。",
  "8000018": "开发账号已到期。",
  "0000001008": "访问令牌无效或已被其他登录挤下线。仅配 GANGTISE_TOKEN 时请手动更新令牌（或改配 GANGTISE_ACCESS_KEY/GANGTISE_SECRET_KEY 以自动刷新）；已配 key 仍报此错说明自动刷新重试后仍被拒，请检查是否有其他客户端用同一账号反复登录。",
  "903301": "今日调用次数已达上限。",
